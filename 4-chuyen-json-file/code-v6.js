...
// Hàm thay thế từ "Fahasa.com" bằng "Fabico.vn"
function replaceFahasaWithFabico(text) {
    return text.replace(/Fahasa\.com/g, 'Fabico.vn');
}
...
fs.readFile('data.json', 'utf8', (err, data) => {
    ...
    jsonData.forEach(item => {
        // Thay thế từ "Fahasa.com" bằng "Fabico.vn"
        ...
        const firstRow = {
            ...
            'Danh mục EN': toSlug(item.category || ""), // Chuyển Danh_mục thành slug cho Danh_mục_EN
